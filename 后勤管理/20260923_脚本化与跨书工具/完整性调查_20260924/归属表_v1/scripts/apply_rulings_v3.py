#!/usr/bin/env python3
"""apply_rulings_v3.py —— 追加式裁定日志（缺口5）v3：读 rulings.jsonl，把裁定叠加到 attribution.csv 上，
...
v2起改为：如果 scope 里给了 module，就要求 field 必须是该 module 对应的 `归属_<module>` 列，
...
用法：
  python3 apply_rulings_v3.py --attribution attribution.csv --rulings rulings.jsonl --out attribution_ruled.csv
"""
import sys
